			...
			if(mysqli_num_rows($result) > 0){
				...
				// output data of each row
                    while($row = mysqli_fetch_array($result)){
                        ...
                        echo "<td>";
                        echo "<a href='updateDependent.php?Essn=". $Ssn ."&Dependent_name=". $row['Dependent_name'] ."' title='Update Record' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                        echo "<a href='deleteDependent.php?Essn=". $Ssn ."&Dependent_name=". $row['Dependent_name'] ."' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                    echo "</td>";
                        echo "</tr>";
                    }
                    echo "</tbody>";                            
